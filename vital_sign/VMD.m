...
% alpha   - the balancing parameter of the data-fidelity constraint 惩罚因子，也称平衡参数
% tau     - time-step of the dual ascent ( pick 0 for noise-slack ) 噪声容忍度
% K       - the number of modes to be recovered 分解的模态数
% DC      - true if the first mode is put and kept at DC (0-freq) 直流分量
% init    - 0 = all omegas start at 0 初始化中心频率
%                    1 = all omegas start uniformly distributed
%                    2 = all omegas initialized randomly
% tol     - tolerance of convergence criterion; typically around 1e-6 收敛准则容忍度
%
% Output:
% -------
...
% other inits
uDiff = tol+eps; % update step（tol是收敛准则的容忍度）终止条件，即论文中的ε
n = 1; % loop counter
